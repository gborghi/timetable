...
# build_world(db) has moved to webui/backend/engine_io.py (audit A5).
# This module no longer imports from webui. Callers should pass a
# pre-built world dict from engine_io.build_world(db) to evaluate().
