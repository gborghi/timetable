...
def build_world(db) -> dict[str, list]:
    ...
    try:
        from backend import models, engine_io  # type: ignore
    except ImportError:
        from webui.backend import models, engine_io  # type: ignore
    out: dict[str, list] = {}
    ...
    try:
        from backend import models as _m  # type: ignore
    except ImportError:
        from webui.backend import models as _m  # type: ignore
