...
DIAGNOSTICS = [
    ("/api/diagnostics/hall-check",
        lambda: _post("/api/diagnostics/hall-check", {"n_samples": 64})),
    ("/api/diagnostics/montecarlo",
        lambda: _post("/api/diagnostics/montecarlo", {"n_samples": 64})),
    ("/api/diagnostics/bipartite (classes)",
        lambda: _post("/api/diagnostics/bipartite", {"mode": "classes"})),
    ("/api/diagnostics/bipartite (teachers)",
        lambda: _post("/api/diagnostics/bipartite", {"mode": "teachers"})),
    ("/api/diagnostics/correlations",
        lambda: _post("/api/diagnostics/correlations", {})),
    ("/api/diagnostics/correlations/variables",
        lambda: _get("/api/diagnostics/correlations/variables")),
    ("/api/diagnostics/distributions",
        lambda: _post("/api/diagnostics/distributions", {})),
    ("/api/diagnostics/distributions/menu",
        lambda: _get("/api/diagnostics/distributions/menu")),
