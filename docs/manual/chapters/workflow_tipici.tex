...
\grokfig{fig_happy_path_aula}{L'aula al primo orario funzionante:
quindici studenti felici e calendario settimanale alla cattedra.}
...
\grokfig{fig_no_solution_ape}{L'ape confusa: cosa fare quando
non esiste soluzione e bisogna rilassare un vincolo.}
...
\grokfig{fig_merge_rivoletti}{Tre rivoletti d'acqua confluiscono
nel fiume \texttt{main} a valle del merge.}
...
\grokfig{fig_supplenza_volante}{La docente in supplenza vola
verso l'aula con la sua cartelletta sotto braccio.}
...
\item Per ogni cella rossa, click sulla cella. Si apre un
  ...
  \emph{docenti disponibili} a destra. In cima alla lista
  stanno i docenti in disposizione ufficiale (badge
  \textbf{DISP}), poi chi ha un buco (badge \textbf{BUCO},
  evidenziato), poi il potenziamento, poi gli altri liberi.
\item Se vuoi un collega della stessa materia, usa i chip
  \emph{Stessa materia} o \emph{Materie del collega} (e,
  se serve, la ricerca per nome). La disposizione
  prescinde dalla materia: i filtri selezionano solo chi
  mostrare. Il badge \textbf{MAT} marca chi insegna la
  stessa disciplina della lezione scoperta.
...
\paragraph{Prima della prima volta.} Imposta la quota di
disposizione nella scheda di ciascun docente e, dal bottone
\emph{Ore di disposizione} della stessa tab, il tetto
scolastico e chi \`e eleggibile. \emph{Salva e piazza}
riempie gli slot ad alta priorit\`a (sabato, prime ore).
Le ore si spostano poi a mano dal tab Orario.
...
3 ore): nove celle scoperte. Il sistema mette in cima i
docenti in disposizione e chi ha un buco; il chip
\emph{Stessa materia} restringe la rosa ai colleghi di
matematica / storia / inglese. La copertura si chiude in
dodici minuti.
\end{esempiobox}

\grokfig{fig_backup_snapshot}{La clessidra del backup con le
istantanee datate al posto della sabbia.}
