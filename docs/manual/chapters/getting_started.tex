...
porta un nuovo lettore, sviluppatore o operatore di segreteria
didattica, da una macchina vergine al primo orario
...
\texttt{import\_profs\_into\_db()} (assegnamenti) e, in modo
opzionale,
