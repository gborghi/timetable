% Manuale tecnico del progetto Carpe Diem (codename: timetable).
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textit{Carpe Diem -- manuale tecnico}}
\fancyhead[R]{\thepage}
...
\upshape\small Orazio, \emph{Odi}, I, 11
...
\emph{Carpe Diem} (codename interno: \texttt{timetable}) \`e un
sistema di generazione e gestione dell'orario scolastico per un
Liceo italiano. Il nome richiama il celebre verso oraziano
``Carpe diem, quam minimum credula postero'' (Orazio, \emph{Odi}, I,
11): l'app organizza il tempo della scuola \emph{adesso}, senza
fidarsi del domani per coprire i buchi.
